...
describe('rev.fields.validators', () => {
    ...
    describe('requiredValidator()', () => {
        ...
        it('returns valid = true when a value is specified', () => {
            ...
            test.name = 'flibble';
            vld.requiredValidator(test, nameField, op, vResult, opts);
    ...
    describe('stringValidator()', () => {
        ...
        it('returns valid = true when a value is not defined', () => {
            let test = new TestModel();
            vld.stringValidator(test, nameField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('stringEmptyValidator()', () => {
        ...
        it('returns valid = true when a value is not specified', () => {
            let test = new TestModel();
            vld.stringEmptyValidator(test, nameField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('regExValidator()', () => {
        ...
        it('returns valid = true when a value is not defined', () => {
            let test = new TestModel();
            vld.regExValidator(test, nameField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('numberValidator()', () => {
        ...
        it('returns valid = true when a value is not defined', () => {
            let test = new TestModel();
            vld.numberValidator(test, ageField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('integerValidator()', () => {
        ...
        it('returns valid = true when a value is not defined', () => {
            let test = new TestModel();
            vld.integerValidator(test, ageField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('booleanValidator()', () => {
        ...
        it('returns valid = true when a value is not defined', () => {
            let test = new TestModel();
            vld.integerValidator(test, booleanField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
        ...
        it('returns valid = true when a boolean is specified and true', () => {
            let test = new TestModel();
            test.isAwesome = true;
            vld.booleanValidator(test, booleanField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('minLengthValidator()', () => {
        ...
        it('returns valid = true when a string is longer than minLength', () => {
            let test = new TestModel();
            test.name = 'flibble';
            vld.minStringLengthValidator(test, nameField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('maxLengthValidator()', () => {
        ...
        it('returns valid = true when a string is shorter than maxLength', () => {
            let test = new TestModel();
            test.name = 'flibble';
            vld.maxStringLengthValidator(test, nameField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('minValueValidator()', () => {
        ...
        it('returns valid = true when a number is greater than minValue', () => {
            let test = new TestModel();
            test.age = 25;
            vld.minValueValidator(test, ageField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
        ...
        it('returns valid = true when a string is greater than minValue', () => {
            let test = new TestModel();
            test.name = 'f';
            vld.minValueValidator(test, nameField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('maxValueValidator()', () => {
        ...
        it('returns valid = true when a number is less than maxValue', () => {
            let test = new TestModel();
            test.age = 22;
            vld.maxValueValidator(test, ageField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
        ...
        it('returns valid = true when a string is less than maxValue', () => {
            let test = new TestModel();
            test.name = 'b';
            vld.maxValueValidator(test, nameField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('singleSelectionValidator()', () => {
        ...
        it('returns valid = true when a value is not defined', () => {
            let test = new TestModel();
            vld.singleSelectionValidator(test, genderField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('listEmptyValidator()', () => {
        ...
        it('returns valid = true when value is not defined', () => {
            let test = new TestModel();
            vld.listEmptyValidator(test, hobbiesField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('multipleSelectionValidator()', () => {
        ...
        it('returns valid = true when a value is not defined', () => {
            let test = new TestModel();
            vld.multipleSelectionValidator(test, hobbiesField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('dateOnlyValidator()', () => {
        ...
        it('returns valid = true when a value is not defined', () => {
            let test = new TestModel();
            vld.dateOnlyValidator(test, dateField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('timeOnlyValidator()', () => {
        ...
        it('returns valid = true when a value is not defined', () => {
            let test = new TestModel();
            vld.timeOnlyValidator(test, dateField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
    ...
    describe('dateTimeValidator()', () => {
        ...
        it('returns valid = true when a value is not defined', () => {
            let test = new TestModel();
            vld.dateTimeValidator(test, dateField, op, vResult, opts);
            expect(vResult.valid).to.equal(true);
        });
